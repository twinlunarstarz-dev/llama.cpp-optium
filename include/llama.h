...
extern "C" {
    ...
    struct llama_model_params {
        ...
        bool sequential_load; // stream layers from disk, auto-fit GPU VRAM, layer-by-layer paging
    };
    ...
    LLAMA_API uint32_t llama_n_seq_max_resident(const struct llama_context * ctx);
