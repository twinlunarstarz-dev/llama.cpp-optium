...
common_init_result::common_init_result(common_params & params, bool model_only) :
    ...
    // Validate before fit probing or model I/O. Router admission is deferred to
    // Patch B; each spawned child still reaches this direct initialization gate.
    common_validate_sequential_params(params);
